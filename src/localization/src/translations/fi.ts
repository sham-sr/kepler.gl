...
export default {
  ...
  effectDescription: {
    lightAndShadow: 'Simuloi realistista auringonvaloa ja varjojen heijastusta vuorokaudenajan ja maantieteellisen sijainnin perusteella. Säädettävä varjon voimakkuus, auringon- ja ympäristövalon värit.',
    ...
    brightnessContrast: 'Säätää kartan yleistä kirkkautta ja kontrastia. Käytä positiivisia arvoja kirkastaaksesi tai lisätäksesi kontrastia, negatiivisia arvoja tummentaaksesi tai tasoittaaksesi kuvaa.',
    hueSaturation: 'Siirtää värisävyä ja säätää kylläisyyttä koko kartalla. Hyödyllinen väriteemojen luomiseen tai näkymän värikylläisyyden vähentämiseen.',
    vibrance: 'Nostaa valikoivasti himeiden värien voimakkuutta ylikyllästämättä jo eläviä värejä. Tuottaa luonnollisemman näköisen värinparannuksen kuin kylläisyys.',
    sepia: 'Käyttää lämmintä ruskeaa sävyä, joka muistuttaa vanhoja valokuvia. Hallitse määrää sekoittaaksesi alkuperäisten värien ja seepiamaisen ulkoasun välillä.',
    dotScreen: 'Muuntaa kuvan mustavalkoisten pisteiden kuvioksi, joka muistuttaa sanomalehtien rasteripainatusta. Säädä kulmaa, pisteen kokoa ja keskikohtaa.',
    colorHalftone: 'Simuloi CMYK-värirasteripinatusta erillisillä pistekuvioilla kullekin värikanavalle. Hallitse kulmaa, pisteen kokoa ja keskikohtaa.',
    noise: 'Lisää satunnaista filmirakeista kohinaa kartalle. Hyödyllinen teksturoidun, analogisen estetiikan luomiseen tai väriporrastuksen vähentämiseen.',
    triangleBlur: 'Käyttää tasaista gaussimaista sumennusta tasaisesti kartalla. Hallitse sumennuksen sädettä pehmeyden tason säätämiseksi.',
    zoomBlur: 'Luo säteittäisen liikesumennuksen, joka lähtee keskipisteestä simuloiden kamerazoomia. Säädä voimakkuutta ja keskikohtaa.',
    tiltShift: 'Simuloi tilt-shift-linssitehostetta, joka sumentaa tarkennuskaistan ulkopuoliset alueet luoden pienoismallimaisen ulkoasun. Aseta tarkennuskaista alku-/loppukohdilla.',
    edgeWork: 'Korostaa kuvan rakenteellisia reunoja taiteellisella hiilipiirrostyylillä. Säädä tunnistussädettä viivan paksuuden hallitsemiseksi.',
    vignette: 'Tummentaa kartan kulmat ja reunat ohjaten huomion keskelle. Hallitse tummentamisen määrää ja kirkkaan alueen sädettä.',
    magnify: 'Luo pyöreän suurennuslasin peiton asetettavaan kohtaan. Säädä kokoa, zoomaustasoa ja reunuksen leveyttä.',
    hexagonalPixelate: 'Korvaa kuvan heksagonaalisten laattojen ruudukolla, joista kukin on täytetty kattamansa alueen keskivärillä. Säädä laatan mittakaavaa.',
    distanceFog: 'Häivyttää kaukaisia kohteita sumuväriksi niiden syvyyden perusteella kamerasta, tehostamalla syvyysvaikutelmaa. Hallitse tiheyttä, alkuetäisyyttä, aluetta ja sumun väriä.',
    surfaceFog: 'Renderöi sumukerroksen tietyllä korkeudella maanpinnan yläpuolella. Säädä korkeutta, siirtymän paksuutta, tiheyttä, väriä ja valinnaista kohinakuviota.'
  },
  layerConfiguration: {
  ...
  modal: {
    ...
    exportMap: {
      ...
      html: {
        ...
        tokenSecurityWarning: '* Varoitus: Mapbox-tunnisteesi upotetaan vietyyn HTML-tiedostoon. Kuka tahansa, jolla on pääsy tähän tiedostoon, voi nähdä ja käyttää tunnistettasi. Käytä mahdollisuuksien mukaan URL-rajoitettua tunnistetta. ',
    ...
    tripInfo: {
      ...
      descriptionTable1: 'Matkat voidaan luoda yhdistämällä luettelo pisteistä leveys- ja pituusasteista, lajittelemalla aikaleiman mukaan ja ryhmittelemällä yksilöivillä tunnuksilla.',
      example: 'Esimerkki:',
...
`
    ...
    loadStorageMap: {
      ...
      foursquareStorageMessage: 'Tässä näytetään vain kartat, jotka on tallennettu Kepler.gl > Tallenna > Foursquare-tallennus -vaihtoehdon avulla'
    }
  },
  header: {
