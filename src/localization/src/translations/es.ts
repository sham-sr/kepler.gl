...
export default {
  ...
  effectDescription: {
    lightAndShadow: 'Simula iluminación solar realista y proyección de sombras basada en la hora del día y la ubicación geográfica. Intensidad de sombra, colores de luz solar y ambiental ajustables.',
    ...
    brightnessContrast: 'Ajusta el brillo y contraste generales del mapa. Usa valores positivos para aumentar el brillo o el contraste, valores negativos para oscurecer o aplanar la imagen.',
    hueSaturation: 'Cambia el tono de color y ajusta la saturación en todo el mapa. Útil para crear temas de color o desaturar la vista.',
    vibrance: 'Aumenta selectivamente la intensidad de los colores apagados sin sobresaturar los ya vivos. Produce una mejora de color más natural que la saturación.',
    sepia: 'Aplica un tono marrón cálido reminiscente de fotografías antiguas. Controla la cantidad para mezclar entre los colores originales y el aspecto sepia.',
    dotScreen: 'Convierte la imagen en un patrón de puntos monocromos, similar a la impresión de semitonos de periódico. Ajusta el ángulo, el tamaño de los puntos y la posición central.',
    colorHalftone: 'Simula la impresión de semitonos de color CMYK con patrones de puntos separados para cada canal de color. Controla el ángulo, el tamaño de los puntos y la posición central.',
    noise: 'Añade ruido aleatorio estilo grano de película al mapa. Útil para una estética texturizada y analógica o para reducir el banding de color.',
    triangleBlur: 'Aplica un desenfoque suave de tipo gaussiano uniformemente en el mapa. Controla el radio de desenfoque para ajustar el nivel de suavidad.',
    zoomBlur: 'Crea un desenfoque de movimiento radial que emana de un punto central, simulando un zoom de cámara. Ajusta la intensidad y la posición central.',
    tiltShift: 'Simula un efecto de lente tilt-shift que desenfoca las áreas fuera de una banda focal, creando un aspecto de maqueta en miniatura. Establece la banda focal con posiciones de inicio/fin.',
    edgeWork: 'Resalta los bordes estructurales de la imagen usando un estilo artístico de dibujo al carbón. Ajusta el radio de detección para controlar el grosor de la línea.',
    vignette: 'Oscurece las esquinas y bordes del mapa, dirigiendo la atención hacia el centro. Controla la cantidad de oscurecimiento y el radio del área clara.',
    magnify: 'Crea una superposición de lupa circular en una posición configurable. Ajusta el tamaño, el nivel de zoom y el ancho del borde.',
    hexagonalPixelate: 'Reemplaza la imagen con una cuadrícula de mosaicos hexagonales, cada uno relleno con el color promedio del área que cubre. Ajusta la escala del mosaico.',
    distanceFog: 'Desvanece los objetos distantes en un color de niebla basado en su profundidad desde la cámara, mejorando la sensación de profundidad. Controla la densidad, la distancia de inicio, el rango y el color de la niebla.',
    surfaceFog: 'Renderiza una capa de niebla a una elevación específica sobre la superficie del terreno. Ajusta la elevación, el grosor de transición, la densidad, el color y un patrón de ruido opcional.'
  },
  layerConfiguration: {
  ...
  modal: {
    ...
    exportMap: {
      ...
      html: {
        ...
        tokenSecurityWarning: '* Advertencia: su token de Mapbox se incrustará en el archivo HTML exportado. Cualquier persona con acceso a este archivo podrá ver y usar su token. Utilice un token con restricciones de URL cuando sea posible. ',
    ...
    tripInfo: {
      ...
      descriptionTable1: 'Los viajes se pueden crear uniendo una lista de puntos de latitud y longitud, ordenando por marcas de tiempo y agrupando por identificadores únicos.',
      example: 'Ejemplo:',
...
`
    ...
    loadStorageMap: {
      ...
      foursquareStorageMessage: 'Solo se muestran aquí los mapas guardados con la opción Kepler.gl > Guardar > Almacenamiento de Foursquare'
    }
  },
  header: {
